    ...
    if (this.props.online) {
      return (
        <div className='person-item-status'>
          ...
          <span className='person-item-status-text'>онлайн</span>
        </div>
      );
    } else {
      return (
        <div className='person-item-status'>
          ...
          <span className='person-item-status-text'>последний раз был {moment(this.props.lastSeen).toNow(true)} назад</span>
        </div>
      );
    }
  }
